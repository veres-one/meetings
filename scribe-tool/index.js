...
// configure scrawl
scrawl.group = 'W3C Veres One CG Telecon';
...
function sendEmail(email, username, password, hostname, content, callback, port=null, ssl=false, tls=false) {
  ...
  var toEmail = `W3C Veres One CG <${process.env.SCRAWL_EMAIL_TO_ADDRESS}>`;
  console.log(toEmail);
...
async.waterfall([ function(callback) {
  ...
  if(program.email) {
    ...
    content = 'Thanks to ' + scribe + ' for scribing this week! The minutes\n' +
      ...
      'https://veres-one.github.io/meetings/'+ gDate + '/\n\n' +
    ...
    var prompt = require('prompt');
      ...
      prompt.get({
        ...
        var tweet = 'Credentials CG discusses ' +
          results.message + ': https://veres-one.github.io/meetings/' +
          gDate + '/ #w3c #ccg';
